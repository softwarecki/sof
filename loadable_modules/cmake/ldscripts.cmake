...
foreach(MODULE ${MODULES_LIST})
    ...
    file(APPEND ${LDSCRIPT_FILE} "INCLUDE ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_text_linker_script.txt\n")
    configure_file(${CMAKE_CURRENT_LIST_DIR}/module_text_linker_script.txt.in ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_text_linker_script.txt)

    file(APPEND ${LDSCRIPT_FILE} "INCLUDE ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_rodata_linker_script.txt\n")
    configure_file(${CMAKE_CURRENT_LIST_DIR}/module_rodata_linker_script.txt.in ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_rodata_linker_script.txt)

    file(APPEND ${LDSCRIPT_FILE} "INCLUDE ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_bss_linker_script.txt\n")
    configure_file(${CMAKE_CURRENT_LIST_DIR}/module_bss_linker_script.txt.in ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}_bss_linker_script.txt)
endforeach()
