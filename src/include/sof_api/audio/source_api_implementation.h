...
#ifndef __SOF_API_AUDIO_SOURCE_API_IMPLEMENTATION_H__
#define __SOF_API_AUDIO_SOURCE_API_IMPLEMENTATION_H__
...
#endif /* __SOF_API_AUDIO_SOURCE_API_IMPLEMENTATION_H__ */
