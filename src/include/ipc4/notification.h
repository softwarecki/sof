...
enum sof_ipc4_notification_type {
	SOF_IPC4_NOTIFY_PHRASE_DETECTED		= 4,//0
	SOF_IPC4_NOTIFY_RESOURCE_EVENT		= 5,//6
	SOF_IPC4_NOTIFY_LOG_BUFFER_STATUS	= 6,//0
	SOF_IPC4_NOTIFY_TIMESTAMP_CAPTURED	= 7,
	SOF_IPC4_NOTIFY_FW_READY		= 8,//duze, statyczna struktura
	SOF_IPC4_FW_AUD_CLASS_RESULT		= 9,
	SOF_IPC4_EXCEPTION_CAUGHT		= 10,//0 ale tu chyba powinien byc zrzucony stos
	SOF_IPC4_MODULE_NOTIFICATION		= 12,//du?e
	SOF_IPC4_UAOL_EVENT			= 13,
	SOF_IPC4_PROBE_DATA_AVAILABLE		= 14,
	SOF_IPC4_WATCHDOG_TIMEOUT		= 15,//0
