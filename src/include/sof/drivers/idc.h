...
/** \brief IDC slave core crashed notify message. */
#define IDC_MSG_SLAVE_CORE_CRASHED		IDC_TYPE(0xA)
#define IDC_MSG_SLAVE_CORE_CRASHED_EXT(x)	IDC_EXTENSION(x)

/** \brief IDC_MSG_SLAVE_CORE_CRASHED header fields. */
...
/** \brief Slave core crash reasons. */
