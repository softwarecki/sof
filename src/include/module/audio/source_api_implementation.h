...
#ifndef __MODULE_AUDIO_SOURCE_API_IMPLEMENTATION_H__
#define __MODULE_AUDIO_SOURCE_API_IMPLEMENTATION_H__
...
#endif /* __MODULE_AUDIO_SOURCE_API_IMPLEMENTATION_H__ */
